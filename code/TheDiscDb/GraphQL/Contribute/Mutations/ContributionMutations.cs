...
public partial class ContributionMutations
{
    ...
    public ContributionMutations(IdEncoder idEncoder, IPrincipalProvider principal, IStaticAssetStore assetStore, [FromKeyedServices(KeyedServiceNames.ImagesAssetStore)] IStaticAssetStore imageStore)
    {
    ...
    private async Task EnsureOwnership(UserManager<TheDiscDbUser> userManager, UserContribution? contribution, string contributionId, string? discId = null, string? itemId = null, CancellationToken cancellationToken = default)
    {
