...
{
    /// <inheritdoc />
    public partial class AddPartialContributionsAndIntake : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscPartialStates", x => x.DiscId);
                    table.ForeignKey(
                        name: "FK_DiscPartialStates_Discs_DiscId",
                        column: x => x.DiscId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReleasePartialStates", x => x.ReleaseId);
                    table.ForeignKey(
                        name: "FK_ReleasePartialStates_Releases_ReleaseId",
            ...
            migrationBuilder.CreateTable(
                name: "UserContributionDiscPartialStates",
                columns: table => new
                {
                    UserContributionDiscId = table.Column<int>(type: "int", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Source = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Note = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserContributionDiscPartialStates", x => x.UserContributionDiscId);
                    table.ForeignKey(
                        name: "FK_UserContributionDiscPartialStates_UserContributionDiscs_UserContributionDiscId",
                        column: x => x.UserContributionDiscId,
            ...
            migrationBuilder.CreateTable(
                name: "UserContributionPartialStates",
                columns: table => new
                {
                    UserContributionId = table.Column<int>(type: "int", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Source = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Note = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserContributionPartialStates", x => x.UserContributionId);
                    table.ForeignKey(
                        name: "FK_UserContributionPartialStates_UserContributions_UserContributionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserContributionDiscs_UserContributionId_Format_ContentHash",
                table: "UserContributionDiscs",
                columns: new[] { "UserContributionId", "Format", "ContentHash" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DiscPartialStates_Type_Reason",
                table: "DiscPartialStates",
                columns: new[] { "Type", "Reason" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReleasePartialStates_Type_Reason",
                table: "ReleasePartialStates",
                columns: new[] { "Type", "Reason" });

            migrationBuilder.CreateIndex(
                name: "IX_UserContributionDiscPartialStates_Type_Reason",
                table: "UserContributionDiscPartialStates",
                columns: new[] { "Type", "Reason" });

            migrationBuilder.CreateIndex(
                name: "IX_UserContributionPartialStates_Type_Reason",
                table: "UserContributionPartialStates",
                columns: new[] { "Type", "Reason" });
        }
