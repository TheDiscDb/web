...
namespace TheDiscDb.Web.Migrations
{
    ...
    [Migration("20260717185706_AddPlaceholderContributionDisc")]
    partial class AddPlaceholderContributionDisc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContributorRelease", b =>
                {
                    ...
                    b.HasKey("ContributorsId", "ReleasesId");

                    b.HasIndex("ReleasesId");

                    b.ToTable("ReleaseContributor", (string)null);
                });
            ...
            modelBuilder.Entity("TheDiscDb.InputModels.Contributor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheDiscDb.InputModels.ReleaseAffiliateLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProviderHandle")
                        .IsRequired()
                        .HasMaxLength(300)
                    ...
                    b.HasIndex("BoxsetSlug", "ReleaseSlug", "Provider")
                        .IsUnique()
                        .HasFilter("[BoxsetSlug] IS NOT NULL");

                    b.HasIndex("MediaItemSlug", "ReleaseSlug", "Provider")
                        .IsUnique()
                        .HasFilter("[MediaItemSlug] IS NOT NULL");

                    b.ToTable("ReleaseAffiliateLinks", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReleaseAffiliateLinks_OneParentSlug", "([MediaItemSlug] IS NOT NULL AND [MediaItemSlug] <> '' AND [BoxsetSlug] IS NULL) OR ([MediaItemSlug] IS NULL AND [BoxsetSlug] IS NOT NULL AND [BoxsetSlug] <> '')");
                        });
                });
            ...
            modelBuilder.Entity("TheDiscDb.InputModels.ReleaseDisc", b =>
                {
                    ...
                    b.HasIndex("ReleaseId", "Index")
                        .IsUnique();

                    b.HasIndex("ReleaseId", "Slug")
                        .IsUnique()
                        .HasFilter("[Slug] IS NOT NULL");

                    b.ToTable("ReleaseDiscs");
                });
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.AchievementAuditEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AchievementAuditEntries");
                });
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.EditSuggestion", b =>
                {
                    ...
                    b.Property<string>("TargetReleasePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.EngramDisc", b =>
                {
                    ...
                    b.Property<int?>("EngramReleaseId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.EngramTitle", b =>
                {
                    ...
                    b.HasIndex("EngramDiscId", "TitleIndex")
                        .IsUnique();
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.UserAchievement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.UserAchievementProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.UserContributionSubtitleTrack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserContributionSubtitleTracks");
                });

            modelBuilder.Entity("TheDiscDb.Web.Data.UserFileNameTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserFileNameTemplates");
                });
            ...
            modelBuilder.Entity("ContributorRelease", b =>
                {
                    b.HasOne("TheDiscDb.InputModels.Contributor", null)
                        .WithMany()
                        .HasForeignKey("ContributorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheDiscDb.InputModels.Release", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.EngramTitle", b =>
                {
                    b.HasOne("TheDiscDb.Web.Data.EngramDisc", "Disc")
                        .WithMany("Titles")
                        .HasForeignKey("EngramDiscId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
