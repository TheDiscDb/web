...
namespace TheDiscDb.Web.Migrations
{
    ...
    [Migration("20260914014850_UnifyEditSuggestionMessages")]
    partial class UnifyEditSuggestionMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.UserMessage", b =>
                {
                    ...
                    b.Property<int?>("EditSuggestionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EditSuggestionId");

                    b.HasIndex("EditSuggestionId", "Purpose")
                        .IsUnique()
            ...
            modelBuilder.Entity("TheDiscDb.Web.Data.UserMessage", b =>
                {
                    ...
                    b.HasOne("TheDiscDb.Web.Data.EditSuggestion", "EditSuggestion")
                        .WithMany()
                        .HasForeignKey("EditSuggestionId")
                        .OnDelete(DeleteBehavior.Cascade);
