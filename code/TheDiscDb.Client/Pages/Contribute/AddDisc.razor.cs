...
public partial class AddDisc : CancellableComponentBase
{
    ...
    async Task OpenFolderAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            this.copyFlowError = "The disc root folder could not be read. Select the physical disc root and try again.";
        }
    }
    ...
    async Task TryCalculateHash()
    {
        ...
        this.request.ContentHash = string.Empty;
        ...
        {
            this.copyFlowError = "No BDMV or VIDEO_TS folder was found. Select the root of the currently inserted physical disc.";
            return;
        }
        ...
        {
            this.copyFlowError = "The selected disc did not contain files that could be hashed. Select the root of the currently inserted physical disc.";
        }
    }
    ...
    {
        this.copyFlowError = null;
        if (!this.scanComplete || string.IsNullOrWhiteSpace(this.request.ContentHash))
        {
            this.copyFlowError = "Scan the currently inserted physical disc before saving.";
            return;
        }
